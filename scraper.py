...
def startUp():
    ...
    boxInformationandIdea = driver.find_element(By.ID, 'checkbox-information and ideas')
    boxCraftAndStructure = driver.find_element(By.ID, 'checkbox-craft and structure')
    boxExpression = driver.find_element(By.ID, 'checkbox-expression of ideas')
    boxStandardEnglish = driver.find_element(By.ID, 'checkbox-standard english conventions')
